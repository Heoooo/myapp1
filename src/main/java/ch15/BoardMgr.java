...
public class BoardMgr {
	...
	private static final String SAVEFOLDER = "C:\\Users\\jinhy\\OneDrive\\바탕 화면\\myapp1\\src\\main\\java\\ch15\\fileupload";
	...
	public void post1000() {
		...
		try {
			con = pool.getConnection();
			sql = "insert tbl Board (name,content,subject,ref,pos,depth,regdate,pass,count,ip,filename,filesize)";
