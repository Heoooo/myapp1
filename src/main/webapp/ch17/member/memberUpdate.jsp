...
<tr>
	...
	<tr>
		<td width="20%">아이디</td>
		<td width="80%"><input name="id" size="15" value="<%=id %>" readonly></td>
	</tr>
	<tr>
		<td>패스워드</td>
		<td><input type="password" name="pwd" size="15" value="<%=mBean.getPwd()%>"></td>
	</tr>
	<tr>
		<td>이름</td>
		<td><input name="name" size="15" value="<%=mBean.getName() %>"></td>
	</tr>
	<tr>
		<td>성별</td>
		<td>남<input type="radio" name="gender" value="1" <%=mBean.getGender().equals("1")?"checked":"" %>>
		여<input type="radio" name="gender" value="2" <%=mBean.getGender().equals("2")?"checked":"" %>></td>
	</tr>
	<tr>
		<td>생년월일</td>
		<td><input name="birthday" size="6" value="<%=mBean.getBirthday() %>">ex)991105</td>
	</tr>
	<tr>
		<td>Email</td>
		<td><input name="email" size="30" value="<%=mBean.getEmail() %>"></td>
	</tr>
	<tr>
		<td>우편번호</td>
		<td><input name="zipcode" size="5" value="<%=mBean.getZipcode() %>" readonly>
